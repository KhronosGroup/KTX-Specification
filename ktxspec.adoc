...
:docver: 2
:ktxver: 2.0
:revnumber: {ktxver}.{docver}
:revdate: {docdate}
:version-label: Format and Document Version
:lang: en
:docinfo1:
:doctype: article
:encoding: utf-8
...
|===
| Document Version |    Date     | Remark
|         1        | 2017-12-08  | First incarnation.
|     {docver}     |  {revdate}  | Update discussion in >4GB issue.
|===
