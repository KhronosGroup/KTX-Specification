...
The value is a four-byte NUL-terminated string formatted as (PCRE):
...
- red and green channels are sampled from red and green texture 
components respectively;
- blue channel is set to zero, ignoring texture data;
- alpha channel is set to one (fully saturated), ignoring texture data.
